...
import rese from '../assets/research.png';
import cert from '../assets/certs.png';
        ...
        <div id="Skills" style={sect}>
            ...
            <div style={cardCont}>
                <div style={cardit} id="Software">
                    <img style={cimg} src={soft} alt="An image of a computer monitor."></img>
                ...
                <div style={cardit} id="Hardware">
                    <img style={cimg} src={hard} alt="An image of a wrench and a microcontroller."></img>
                ...
                <div style={cardit} id="Research">
                    <img style={cimg} src={rese} alt="An image of a paper"></img>
                ...
                <div style={cardit} id="Certifications">
                    <img style={cimg} src={cert} alt="An image of a license."></img>
